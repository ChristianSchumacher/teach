...
Question.create({"question" => "16 / 8", "answer_1" => "2", "answer_2" => "4", "answer_3" => "11", "answer_4" => "2.5", "answer_5" => "16", "solution"=> "01000", "author_id" => 1, "area_id" => 1 })
Question.create({"question" => "16-2", "answer_1" => "2", "answer_2" => "4", "answer_3" => "11", "answer_4" => "2.5", "answer_5" => "16", "solution"=> "01000", "author_id" => 1, "area_id" => 1 })
Question.create({"question" => "4-4", "answer_1" => "2", "answer_2" => "4", "answer_3" => "11", "answer_4" => "2.5", "answer_5" => "16", "solution"=> "01000", "author_id" => 1, "area_id" => 1 })
Question.create({"question" => "2+2", "answer_1" => "2", "answer_2" => "4", "answer_3" => "11", "answer_4" => "2.5", "answer_5" => "16", "solution"=> "01000", "author_id" => 1, "area_id" => 1 })
Question.create({"question" => "2+2", "answer_1" => "2", "answer_2" => "4", "answer_3" => "11", "answer_4" => "2.5", "answer_5" => "16", "solution"=> "01000", "author_id" => 1, "area_id" => 1 })
Question.create({"question" => "2+2", "answer_1" => "2", "answer_2" => "4", "answer_3" => "11", "answer_4" => "2.5", "answer_5" => "16", "solution"=> "01000", "author_id" => 1, "area_id" => 1 })
